    ...
    for(;;)
      {
        ...
        cap>>image;
        //imshow("original",image);                                             //Unmodified image--uncomment to debug program            //Get a new frame from camera
        ...
        //ObstacleDetectexport LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib
        ...
        flip(bnw,bnw,1);                                                        //Flip image because it's mirrored
        linimg = bnw;                                                           //Pass processed image to global variable
        imshow("Final Image", linimg);                                          //Display final processed image--uncomment to debug LineDetect
